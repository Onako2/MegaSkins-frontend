...
export default function SafetyCheck({ hash }: SafetyProps) {
  ...
  return (
    <div className="basis-128 m-8 rounded-md grid">
      <p>{similarity}</p>
      <button id="safety_button" className="outline-indigo-500 outline-dotted outline-3 outline-offset-5 hover:outline-yellow-500 transition-all duration-700" onClick={() => {
